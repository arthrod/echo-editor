...
import { Focus, Placeholder, Dropcursor, Gapcursor, CharacterCount } from '@tiptap/extensions'
import type { FocusOptions, PlaceholderOptions, DropcursorOptions, CharacterCountOptions } from '@tiptap/extensions'
